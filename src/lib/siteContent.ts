...
export const CONTENT_DEFAULTS: Record<string, string> = {
  ...
  // ---- FAQs (6 real questions families ask — all editable in the admin
  //      Content tab; empty slots stay hidden) ----
  ...
  faq_a6:
    "Our academic calendar runs by Islamic (Hijri) and civil dates each session — see the Academic Calendar on our home page for term dates, examinations, and important events such as the Qur’an competition.",
  faq_heading_gap: "40",
  faq_padding_top: "96",
