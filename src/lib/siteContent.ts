...
export const CONTENT_FIELDS: ContentField[] = [
  ...
  { key: "welcome_cta_label", label: "Welcome CTA Label (Home → Director's Message)", type: "text", group: "Text & Announcements" },
...
export const CONTENT_DEFAULTS: Record<string, string> = {
  ...
  welcome_cta_label: "Read the Director's Welcome Message",
  nav_home_label: "Home",
